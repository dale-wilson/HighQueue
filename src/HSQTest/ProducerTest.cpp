...
BOOST_AUTO_TEST_CASE(testProducer)
{
    ...
    HSQEntry & firstEntry = accessor[*readPosition];
    BOOST_CHECK_EQUAL(firstEntry.status_, HSQEntry::Status::OK);
    HSQueue::Message & firstMessage = firstEntry.message_;
    ...
    BOOST_CHECK_EQUAL(firstEntry.status_, HSQEntry::Status::OK);
    HSQueue::Message & newestMessage = firstEntry.message_;
